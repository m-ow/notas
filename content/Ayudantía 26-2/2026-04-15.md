...
$$  
\begin{prooftree}  
\Axiom$ \Gamma  \vdash \fCenter \Sigma$  

\UnaryInf$ \Gamma, A \vdash  \fCenter \Sigma$  
\end{prooftree}  
$$
...
$$  
\begin{prooftree}  
\Axiom$ \Gamma A,A \vdash \fCenter \Sigma$  
...
$$  
\begin{prooftree}  
\Axiom$ \Gamma , \neg A \vdash \fCenter \bot$  

\UnaryInf$ \Gamma, A \vdash  \fCenter A$  
\end{prooftree}  
$$
